    ...
    <section>
      <div className="max-w-7xl mt-32 m-auto">
        <div className="lg:ml-80 ml-8">
          ...
          <p className="lg:w-[500px] lg:text-center text-start mt-6 lg:ml-32 w-72">Quer você seja uma pequena empresa ou uma grande corporação, temos o plano certo para você</p>
        </div>
        <div className="mt-20 flex lg:flex-row gap-12 flex-col  mx-2 lg:mx-0 ">
          <div className="lg:w-96 w-[330px] bg-gray-50 p-8 rounded-xl drop-shadow-md">
          ...
          <div className="lg:w-[760px] mx-2 lg:mx-0 relative flex lg:flex-row flex-col text-gray-50 bg-blue-500 p-8 rounded-xl drop-shadow-md">
            <div>
              ...
              <p className="pb-7 lg;w-80">Orçamento integrado e aproveite melhor seu dinheiro com sua conta plus</p>
